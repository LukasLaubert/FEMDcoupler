...
class ParamConfig:
    ...
    output_file = "../zBuilder/theCoupledOutput_burrito" # file name of the output files excluding file extension with (optional) output path

    # --- FE GEOMETRY PARAMETERS ---
    # (a) rectangular FE systam: set 'circular_burrito_radius = None' below to use
    domain_min_coords = [50, 100, None]  # X_min, Y_min, Z_min of FE domain (or None for PBCs in this direction)
    domain_max_coords = [350, 250, None] # X_max, Y_max, Z_max of FE domain (or None for PBCs in this direction)
...
#    mesh_coarsening_factor = 3           # coarsens mesh with values >1 by the factor given up to the outermost border; refines mesh with 0<values<1; disable with None or 0 or 1 # NOT IMPLEMENTED
    ...
    # - NOTCH -
    notch_thickness = None    # thickness of a centered notch along the specified plane (positive and negative values lead to same result; None means "no notch", function is skipped; 0 will result in thickness of tol)
